  ...
  "@graph": [
    {
      ...
      "description": "Store dead-lettered spatial webhook events in a PostGIS table with nullable geometry and a JSONB payload, driven by Celery task failure hooks — with DDL, code, and tests.",
      "url": "https://geospatialwebhook.com/queue-management-retry-delivery/dead-letter-queues-spatial/building-a-spatial-dlq-with-postgis-and-celery/",
      "datePublished": "2025-05-01",
      "dateModified": "2026-07-13",
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Building a Spatial DLQ with PostGIS and Celery", "item": "https://geospatialwebhook.com/queue-management-retry-delivery/dead-letter-queues-spatial/building-a-spatial-dlq-with-postgis-and-celery/" }
      ]
    },
    {
      "@type": "HowTo",
...
This page sits within [Dead-Letter Queues for Spatial Payloads](/queue-management-retry-delivery/dead-letter-queues-spatial/), part of the broader [Queue Management, Retries & Delivery Guarantees](/queue-management-retry-delivery/) pillar — the reference section for keeping spatial webhook pipelines reliable under failure.
...
- [Dead-Letter Queues for Spatial Payloads](/queue-management-retry-delivery/dead-letter-queues-spatial/) — parent: dead-letter design patterns across brokers and stores for spatial events
- [Replaying Dead-Letter Spatial Events Safely](/queue-management-retry-delivery/dead-letter-queues-spatial/replaying-dead-letter-spatial-events-safely/) — draining the rows this table stores back into the pipeline without re-corrupting state
- [Geometry Validation Pipelines](/spatial-payload-routing-parsing/geometry-validation-pipelines/) — catching invalid topology and CRS mismatches before they reach the DLQ
