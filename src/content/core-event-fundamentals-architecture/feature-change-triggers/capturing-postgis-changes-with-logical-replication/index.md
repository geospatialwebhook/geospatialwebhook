...
<text x="26" y="206" font-size="9" fill="var(--fig-ink-soft)">Not less work — work moved off the critical path. The decoder is now something that can fall behind, and while it is behind the database cannot recycle its log.</text>
</svg>
