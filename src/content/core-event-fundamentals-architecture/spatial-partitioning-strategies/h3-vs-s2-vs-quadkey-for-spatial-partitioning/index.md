  ...
  "@graph": [
    {
      ...
      "description": "A definitive comparison of Uber H3, Google S2, and Bing Quadkey as partition and shard keys for geospatial event streams, with runnable Python for all three.",
      "url": "https://www.geospatialwebhook.com/core-event-fundamentals-architecture/spatial-partitioning-strategies/h3-vs-s2-vs-quadkey-for-spatial-partitioning/",
      "datePublished": "2025-05-01",
      "dateModified": "2026-07-13",
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 2, "name": "Spatial Partitioning Strategies for Event Streams", "item": "https://www.geospatialwebhook.com/core-event-fundamentals-architecture/spatial-partitioning-strategies/" },
        { "@type": "ListItem", "position": 3, "name": "H3 vs S2 vs Quadkey for Spatial Partitioning", "item": "https://www.geospatialwebhook.com/core-event-fundamentals-architecture/spatial-partitioning-strategies/h3-vs-s2-vs-quadkey-for-spatial-partitioning/" }
      ]
    },
    {
      "@type": "HowTo",
...
- You are choosing a broker layout and want the key format documented in [Broker Selection & Partitioning for Spatial Streams](https://www.geospatialwebhook.com/queue-management-retry-delivery/broker-selection-partitioning/) to be deterministic and language-agnostic.
...
<figure class="fig">
<svg viewBox="31 1 695 190" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Cell shape and hierarchy of H3, S2, and Quadkey grid systems">
  ...
  <rect x="31" y="1" width="695" height="190" fill="var(--fig-bg)"/>
  <!-- H3 panel -->
...
<figcaption><b>Figure 1.</b> Cell shape and hierarchy of H3, S2, and Quadkey</figcaption>
</figure>
...
<figure class="fig">
<svg viewBox="0 0 760 236" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Exact quadtree nesting in S2 and Quadkey contrasted with the approximate hexagon nesting in H3">
<title>Quadtrees nest exactly; hexagons do not</title>
<desc>On the left, an S2 or Quadkey parent square is subdivided into four children that tile it precisely, with no gap and no overlap, so rolling a child key up to its parent is exact. On the right, an H3 parent hexagon is overlaid with its seven approximate children: the centre child sits wholly inside, while the six ring children each straddle the parent boundary, so part of each belongs to a neighbouring parent. Rolling up therefore leaks a small amount of area across the edge, which shows up as a few tenths of a percent of events aggregating into the wrong parent cell.</desc>
<rect x="0" y="0" width="760" height="236" fill="var(--fig-bg)"/>
<text x="180" y="22" text-anchor="middle" font-size="11" font-weight="600" fill="var(--fig-mint-edge)">S2 / Quadkey — exact 4:1 nesting</text>
<rect x="100" y="34" width="160" height="160" fill="none" stroke="var(--fig-mint-edge)" stroke-width="2.4"/>
<rect x="100" y="34" width="80" height="80" fill="var(--fig-mint)" stroke="var(--fig-mint-edge)" stroke-width="1.2"/>
<rect x="180" y="34" width="80" height="80" fill="var(--fig-mint)" stroke="var(--fig-mint-edge)" stroke-width="1.2"/>
<rect x="100" y="114" width="80" height="80" fill="var(--fig-mint)" stroke="var(--fig-mint-edge)" stroke-width="1.2"/>
<rect x="180" y="114" width="80" height="80" fill="var(--fig-mint)" stroke="var(--fig-mint-edge)" stroke-width="1.2"/>
<text x="140" y="79" text-anchor="middle" font-size="11" fill="var(--fig-ink)">0</text>
<text x="220" y="79" text-anchor="middle" font-size="11" fill="var(--fig-ink)">1</text>
<text x="140" y="159" text-anchor="middle" font-size="11" fill="var(--fig-ink)">2</text>
<text x="220" y="159" text-anchor="middle" font-size="11" fill="var(--fig-ink)">3</text>
<text x="180" y="214" text-anchor="middle" font-size="9.5" fill="var(--fig-ink-soft)">roll-up is exact — chop one character off the key</text>
<line x1="380" y1="24" x2="380" y2="204" stroke="var(--fig-line-soft)" stroke-width="1"/>
<text x="566" y="22" text-anchor="middle" font-size="11" font-weight="600" fill="var(--fig-peach-edge)">H3 — approximate nesting</text>
<polygon points="566,34 634,74 634,154 566,194 498,154 498,74" fill="none" stroke="var(--fig-peach-edge)" stroke-width="2.4"/>
<polygon points="566,90 592,105 592,135 566,150 540,135 540,105" fill="var(--fig-mint)" stroke="var(--fig-mint-edge)" stroke-width="1.2"/>
<polygon points="566,30 592,45 592,75 566,90 540,75 540,45" fill="var(--fig-rose)" stroke="var(--fig-rose-edge)" stroke-width="1.2" opacity="0.85"/>
<polygon points="566,150 592,165 592,195 566,210 540,195 540,165" fill="var(--fig-rose)" stroke="var(--fig-rose-edge)" stroke-width="1.2" opacity="0.85"/>
<polygon points="618,60 644,75 644,105 618,120 592,105 592,75" fill="var(--fig-rose)" stroke="var(--fig-rose-edge)" stroke-width="1.2" opacity="0.85"/>
<polygon points="618,120 644,135 644,165 618,180 592,165 592,135" fill="var(--fig-rose)" stroke="var(--fig-rose-edge)" stroke-width="1.2" opacity="0.85"/>
<polygon points="514,60 540,75 540,105 514,120 488,105 488,75" fill="var(--fig-rose)" stroke="var(--fig-rose-edge)" stroke-width="1.2" opacity="0.85"/>
<polygon points="514,120 540,135 540,165 514,180 488,165 488,135" fill="var(--fig-rose)" stroke="var(--fig-rose-edge)" stroke-width="1.2" opacity="0.85"/>
<text x="566" y="124" text-anchor="middle" font-size="9" fill="var(--fig-ink)">in</text>
<text x="566" y="214" text-anchor="middle" font-size="9.5" fill="var(--fig-ink-soft)">six of seven children straddle the parent edge</text>
<rect x="14" y="212" width="732" height="0" fill="none"/>
</svg>
<figcaption><b>Figure 2.</b> A hexagon cannot be tiled by smaller hexagons, so H3's hierarchy is a containment approximation rather than a partition. Shard at r9 and aggregate at r8 and a small fraction of events lands in a neighbouring parent — usually tolerable, never exactly zero.</figcaption>
</figure>
...
<figure class="fig">
<svg viewBox="0 0 760 250" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Ground width of a zoom-16 Quadkey tile against latitude compared with the constant area of an H3 cell">
<title>Quadkey tile width collapses with latitude; H3 does not</title>
<desc>Ground width of a zoom-16 Quadkey tile plotted against latitude from the equator to eighty-five degrees north. At the equator the tile spans about 611 metres. By forty degrees it is down to about 468 metres, by sixty about 306 metres, by seventy-five about 158 metres, and by eighty-five about 53 metres — roughly a twelfth of its equatorial width. An H3 resolution-8 cell holds a near-constant area of about 0.74 square kilometres at every latitude because it is computed on the sphere. Web Mercator is undefined beyond 85.05 degrees, marked as a hard edge. For a partitioner this means a fixed Quadkey zoom yields cells whose event capacity varies by more than an order of magnitude across a country spanning several degrees of latitude.</desc>
<rect x="0" y="0" width="760" height="250" fill="var(--fig-bg)"/>
<line x1="70" y1="30" x2="70" y2="180" stroke="var(--fig-line)" stroke-width="1.2"/>
<line x1="70" y1="180" x2="560" y2="180" stroke="var(--fig-line)" stroke-width="1.2"/>
<line x1="70" y1="150" x2="560" y2="150" stroke="var(--fig-line-soft)" stroke-width="0.7" stroke-dasharray="3,3"/>
<line x1="70" y1="105" x2="560" y2="105" stroke="var(--fig-line-soft)" stroke-width="0.7" stroke-dasharray="3,3"/>
<line x1="70" y1="60" x2="560" y2="60" stroke="var(--fig-line-soft)" stroke-width="0.7" stroke-dasharray="3,3"/>
<text x="64" y="183" text-anchor="end" font-size="9" fill="var(--fig-ink-soft)">0</text>
<text x="64" y="153" text-anchor="end" font-size="9" fill="var(--fig-ink-soft)">200</text>
<text x="64" y="108" text-anchor="end" font-size="9" fill="var(--fig-ink-soft)">400</text>
<text x="64" y="63" text-anchor="end" font-size="9" fill="var(--fig-ink-soft)">600</text>
<text x="26" y="105" font-size="9.5" fill="var(--fig-ink-soft)" transform="rotate(-90 26 105)" text-anchor="middle">tile ground width (m)</text>
<polyline points="70,58 128,66 186,80 244,110 302,134 360,156 418,167 476,173 534,176" fill="none" stroke="var(--fig-rose-edge)" stroke-width="2.4"/>
<circle cx="70" cy="58" r="3" fill="var(--fig-rose-edge)"/>
<circle cx="244" cy="110" r="3" fill="var(--fig-rose-edge)"/>
<circle cx="360" cy="156" r="3" fill="var(--fig-rose-edge)"/>
<circle cx="534" cy="176" r="3" fill="var(--fig-rose-edge)"/>
<text x="82" y="52" font-size="8.5" fill="var(--fig-ink-soft)">611 m</text>
<text x="252" y="104" font-size="8.5" fill="var(--fig-ink-soft)">468 m at 40°</text>
<text x="368" y="150" font-size="8.5" fill="var(--fig-ink-soft)">306 m at 60°</text>
<text x="470" y="192" font-size="8.5" fill="var(--fig-ink-soft)">53 m at 85°</text>
<line x1="70" y1="46" x2="560" y2="46" stroke="var(--fig-mint-edge)" stroke-width="2.4" stroke-dasharray="7,4"/>
<text x="82" y="42" font-size="8.5" fill="var(--fig-mint-edge)" font-weight="600">H3 r8 — 0.74 km² at every latitude</text>
<line x1="548" y1="30" x2="548" y2="180" stroke="var(--fig-earth-edge)" stroke-width="1.4"/>
<text x="70" y="200" text-anchor="middle" font-size="9" fill="var(--fig-ink-soft)">0°</text>
<text x="186" y="200" text-anchor="middle" font-size="9" fill="var(--fig-ink-soft)">30°</text>
<text x="302" y="200" text-anchor="middle" font-size="9" fill="var(--fig-ink-soft)">50°</text>
<text x="418" y="200" text-anchor="middle" font-size="9" fill="var(--fig-ink-soft)">70°</text>
<text x="534" y="200" text-anchor="middle" font-size="9" fill="var(--fig-ink-soft)">85°</text>
<text x="315" y="218" text-anchor="middle" font-size="9.5" fill="var(--fig-ink-soft)">latitude — Web Mercator undefined beyond 85.05°</text>
<rect x="576" y="46" width="170" height="60" rx="5" fill="var(--fig-rose)" stroke="var(--fig-rose-edge)" stroke-width="1.2"/>
<text x="586" y="64" font-size="9.5" font-weight="600" fill="var(--fig-ink)">Quadkey z16</text>
<text x="586" y="79" font-size="9" fill="var(--fig-ink-soft)">width scales with cos(lat) —</text>
<text x="586" y="91" font-size="9" fill="var(--fig-ink-soft)">a 12× span across one country</text>
<rect x="576" y="116" width="170" height="60" rx="5" fill="var(--fig-mint)" stroke="var(--fig-mint-edge)" stroke-width="1.2"/>
<text x="586" y="134" font-size="9.5" font-weight="600" fill="var(--fig-ink)">H3 / S2</text>
<text x="586" y="149" font-size="9" fill="var(--fig-ink-soft)">computed on the sphere, so</text>
<text x="586" y="161" font-size="9" fill="var(--fig-ink-soft)">per-cell capacity stays flat</text>
<rect x="70" y="228" width="676" height="20" rx="4" fill="var(--fig-gold)" stroke="var(--fig-gold-edge)" stroke-width="1.2"/>
<text x="82" y="242" font-size="9.5" fill="var(--fig-ink)">Quadkey's distortion is invisible in a city-scale test and dominant in a national one — pick the grid against your latitude span.</text>
</svg>
<figcaption><b>Figure 3.</b> Quadkey inherits Web Mercator's area distortion, so a fixed zoom gives cells whose event capacity varies more than tenfold across a high-latitude country. H3 and S2 are computed on the sphere and hold capacity roughly flat.</figcaption>
</figure>
...
- [Spatial Partitioning Strategies for Event Streams](https://www.geospatialwebhook.com/core-event-fundamentals-architecture/spatial-partitioning-strategies/) — the parent guide to choosing and sizing a grid for spatial sharding
- [Broker Selection & Partitioning for Spatial Streams](https://www.geospatialwebhook.com/queue-management-retry-delivery/broker-selection-partitioning/) — where these cell ids become concrete Kafka and Redis Streams partition keys
- [Core Event Fundamentals & Architecture](https://www.geospatialwebhook.com/core-event-fundamentals-architecture/) — the reference section for designing geospatial event-driven systems in Python
