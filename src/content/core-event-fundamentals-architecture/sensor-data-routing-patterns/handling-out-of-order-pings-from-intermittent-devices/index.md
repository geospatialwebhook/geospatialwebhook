...
<text x="290" y="148" font-size="8.5" fill="var(--fig-rose-edge)">a router trusting arrival order sees: teleport forward · walk backwards through the tunnel · jump forward again</text>
